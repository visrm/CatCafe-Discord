/**
 * DottedMap — the actual magicui.design registry component (unmodified
 * beyond this comment), installed via `svg-dotted-map` for real-world
 * dot sampling instead of the hand-rolled polygon version this file
 * used to contain. See https://magicui.design/docs/components/dotted-map
 */

...
const stats = [
  { value: 12400, suffix: '+', label: 'Total Members',     emoji: '👥', color: '#FF5F57' },
  { value: 1200,  suffix: '+', label: 'Online Right Now',  emoji: '🟢', color: '#06D6A0' },
  { value: 50,    suffix: '+', label: 'Active Channels',   emoji: '💬', color: '#FFD166' },
  { value: 98,    suffix: '%', label: 'Satisfaction Rate', emoji: '❤️', color: '#118AB2' },
]
...
function StatCard({ stat }: { stat: typeof stats[0] }) {
  ...
  return (
    ...
    >
      <div className="text-4xl mb-4 group-hover:animate-wiggle inline-block">{stat.emoji}</div>
      <div
      ...
      <div className="text-[#8892B0] font-semibold text-sm uppercase tracking-widest">{stat.label}</div>
    </div>
  )
}
